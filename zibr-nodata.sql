...
CREATE TABLE `numbers` (
  ...
  `number` int(3) unsigned NOT NULL DEFAULT '1',
  `online` int(2) NOT NULL,
  PRIMARY KEY (`num`)
) ENGINE=MyISAM AUTO_INCREMENT=755 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `user_tracker` (
  ...
  `date` varchar(30) CHARACTER SET cp1251 NOT NULL,
  `user_login` varchar(32) CHARACTER SET cp1251 NOT NULL,
  `number` int(3) unsigned NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-01-17 18:05:53
